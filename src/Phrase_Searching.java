...
//        try {
//            File websitesFile = new File("D:\\CMP2\\2ndTerm\\APT\\project\\GoWell\\src\\stopwords.txt");
...
//        try {
//            File websitesFile = new File("D:\\CMP2\\2ndTerm\\APT\\project\\GoWell\\src\\NonStemmingwords.txt");
//            Scanner reader = new Scanner(websitesFile);
//            while (reader.hasNextLine()) {
//                String word = reader.nextLine();
//                impword.add(word);
